...
def get_page_cameras(page):
    ...
    r = requests.post(domain + "/api/graphql", json=json_data)
...
def main():
    data = [
        {
            "name": "Kansas - Traffic Cameras",
            "episodes": get_all_cameras()
        }
    ]
    f = open("www-kandrive-org.json", "w+")
    json.dump(data, f, ensure_ascii=False, indent=4)
    create_single_m3u("../../lists/cameras/countries/us/traffic", data, "ks")
