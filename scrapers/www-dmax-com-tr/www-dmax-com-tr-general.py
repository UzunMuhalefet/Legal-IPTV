...
ajax_url = "https://www.dmax.com.tr/ajax/more"
...
def get_stream_url(episode_url):
    try:
        ...
        return "https://dygvideo.dygdigital.com/api/redirect?PublisherId=27&ReferenceId={}&SecretKey=NtvApiSecret2014*".format(reference_id)
    except:
        return ""
...
def main(start=0, end=0):
    ...
    f = open("www-dmax-com-tr-programlar.json", "w+")
